...
<style>
    <?php /* Include all CSS variables and base styles from postjob.php */ ?>
    :root {
        --primary: #6a38c2;
        --primary-dark: #5a2caa;
...
<div class="hero-section edit-profile-hero">
    <div class="container">
        <div class="page-header">
            ...
            <p>Update your professional information to attract better opportunities</p>
        </div>
    </div>
    <!-- Add these wave divs -->
            ...
            <div class="form-container">
                <form id="registrationForm" method="post" class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="ri-calendar-line"></i> Date of Birth</label>
                    ...
                    <div class="col-md-6">
                        <h4 class="mb-4"><i class="ri-briefcase-line"></i> Professional Information</h4>
                        
                        <div class="mb-3">
                            <label class="form-label"><i class="ri-medal-line"></i> Professional Title</label>
                            <input type="text" class="form-control" name="prof_title" value="<?php echo $prof_title; ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label"><i class="ri-tools-line"></i> Skills</label>
                            <input type="text" class="form-control" name="skills" value="<?php echo $skills; ?>" required>
                            <small class="text-muted">Separate skills with commas (e.g., HTML, CSS, JavaScript)</small>
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="ri-graduation-cap-line"></i> Education</label>
                            <textarea class="form-control" name="education" rows="2"><?php echo $education; ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label"><i class="ri-history-line"></i> Experience</label>
                            <textarea class="form-control" name="experience" rows="2"><?php echo $experience; ?></textarea>
                        </div>
                    </div>

                    <!-- Submit Button -->
                    <div class="col-12 text-center mt-4">
                        <button type="submit" name="editFreelancer" class="btn btn-primary px-5">
