    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="card text-center p-4">
                ...
                <p class="text-muted mb-4"><i class="ri-user-line"></i> <?php echo $e_user; ?></p>
                <center><a href="sendMessage.php" class="btn btn-primary"><i class="ri-message-2-line"></i> Send Message</a></center>
            </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="panel-heading"><h3><i class="ri-profile-line"></i> Employer Profile Details</h3></div>
                <div class="panel-body">
                    <h4 class="mb-3"><i class="ri-building-line"></i> <?php echo $company; ?></h4>
                    <p><strong>Previously Hired Freelancers:</strong> <?php echo $e_user; ?></p>
            ...
            <div class="card mt-4">
                <div class="panel-heading"><h4><i class="ri-share-line"></i> Social Network Profiles</h4></div>
                <div class="panel-body">
